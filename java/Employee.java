...
public class Employee {
    ...
    public Employee(
            ...
            int age, LocalDate joiningDate, double rating) {
    ...
    public static void main(String[] args) {
        ...
        // employees.stream().filter(e -> e.getName().startsWith("A")
        // && e.getSalary() >
        // 100000).sorted(Comparator.comparing(Employee::getSalary).reversed()).collect(
        // Collectors.toList());
